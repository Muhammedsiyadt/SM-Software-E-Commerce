                                        ...
                                        {Array.isArray(products?.data) === true && products?.data.length >= 1 ? products?.data?.map((e) => {
                                            return (
                                                ...
                                                <div className="col-md-4 col-sm-6 px-2 mb-5" key={e.slug}>
                                                    <ProductCard v={e.v} image={`${process.env.REACT_APP_BASE_URL}/media/product/${e.thumbnail}`} stock={e.stock} id={e.slug} name={e.name} category={e.category.name} original_price={e.unit_price} selling_price={e.offer_price} rating_count={4} />
