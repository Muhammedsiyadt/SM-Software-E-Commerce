...
function RefundList() {
  return (
    <div><div id="main" className="site-main">
      <p />
      <p>
        Thanks for shopping at My Site (change this). If you are not entirely
      ...
      <p>
        ...
        condition that you received it. Your item must be in the original packaging.
      </p>
      ...
      <p>
        ...
        initiate a refund to your credit card (or original method of payment). You
        will receive the credit within 7-15 days, depending on your card issuer’s
        policies.
      </p>
      <p>
      ...
      <p>If you have any questions on how to return your item to us.</p>
    </div>
    </div>
  )
}
